sap.ui.define([
		...
		return BaseObject.extend("medicare.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias medicare.model.ListSelector
			 */
			 ...
			 * @return {medicare.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
